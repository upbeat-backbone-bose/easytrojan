...
case $(uname -m) in
    x86_64)
        caddy_url=https://raw.githubusercontent.com/upbeat-backbone-bose/easytrojan/caddy/caddy_trojan_linux_amd64.tar.gz
        ;;
    aarch64)
        caddy_url=https://raw.githubusercontent.com/upbeat-backbone-bose/easytrojan/caddy/caddy_trojan_linux_arm64.tar.gz
        ;;
    *) 
